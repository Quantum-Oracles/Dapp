import React, { ChangeEvent, ReactNode, createContext, useContext, useRef, useState } from "react";
  ...
  return (
    <>
      <form onSubmit={onSubmit}>
        ...
        <p>
        <button>
            <Button leftIcon={<Icon as={CheckBadgeIcon} />}>Set your Circuit</Button>
        </button>
        </p>
      </form>
      <div>
